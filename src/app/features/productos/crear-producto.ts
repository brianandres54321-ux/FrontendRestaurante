...
import { ProductoRequest } from '../../shared/models/producto.model';
...
export class CrearProducto implements OnInit {
  ...
  guardar(): void {
    ...
    // El código de barras es único por empresa: si se manda "" en vez de
    // omitirlo, el segundo producto sin código choca con el primero.
    this.producto.codigoBarras = this.producto.codigoBarras?.trim() || undefined;
